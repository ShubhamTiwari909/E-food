        ...
        <div className="grid place-content-center pt-10 pb-20">
            <div className="w-purple-claymorphism mx-8">
                ...
                <p className="mt-5 mb-10">
                    This food ingredient website is created with the <a href="https://spoonacular.com/" target="_blank" rel="noreferrer"
                        className="text-purple-700">spoonacular</a> by using their api to fetch the data
                </p>
